...
public class ListClassBean {
    ...
    private List<ListSnClassBean> listSnClass;
    private List<ListPtClassBean> listPtClass;

    public List<ListSnClassBean> getListSnClass() {
        return listSnClass;
    }

    public void setListSnClass(List<ListSnClassBean> listSnClass) {
        this.listSnClass = listSnClass;
    }
    ...
    public static class ListSnClassBean {
        /**
         * id : 58
         * cfName : 呼吸系统常备药品
         * parentCf : 46
